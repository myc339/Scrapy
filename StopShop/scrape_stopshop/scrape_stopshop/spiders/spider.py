...
class Stopshop(scrapy.Spider):
    ...
    def start_requests(self):
        urls = [
            ...
            'https://circular.stopandshop.com/flyers/stopandshop-weekly/grid_view/584734?postal_code=02155&show_shopping_list_integration=1&store_code=2411&type=2&use_requested_domain=true'
